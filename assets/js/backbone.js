...
this["Templates"]['forgot-password'] = function anonymous(locals, attrs, escape, rethrow, merge) {
...
if ( !email_sent)
{
buf.push('<div class="box forgot-pwd"><h2>Forgot password</h2><p>Enter the email address you used when creating the account and click Request password.</p><p>A message will be sent to that address containing the password you entered during the sign up.</p><form autocomplete="off"><input type="text" placeholder="Email address" class="email"/></form><a href="#" title="Request password" class="btn btn-send">Request password</a><a href="#" title="Login" class="info login-action">Or Login instead</a></div>');
}
else
{
buf.push('<div class="box forgot-pwd"><h2>Forgot password</h2><p>Thanks! We\'ve just sent you an e-mail with your password. See you back here soon!</p></div>');
}
}
return buf.join("");
};

this["Templates"]['login'] = function anonymous(locals, attrs, escape, rethrow, merge) {
attrs = attrs || jade.attrs; escape = escape || jade.escape; rethrow = rethrow || jade.rethrow; merge = merge || jade.merge;
var buf = [];
with (locals || {}) {
var interp;
buf.push('<div class="box login"><h2>Login with your Paperboard Account</h2><form autocomplete="off"><input type="text" placeholder="Email address" class="email"/><input type="password" placeholder="Password" class="password"/></form><a href="#" title="Login with your account" class="btn-login">Login</a><a href="#" title="Request a new password" class="forgot-password">Forgot password?</a></div><div class="box signup"><h2>No account?</h2><p>Future claim</p><a href="/login" data-navigate="data-navigate" title="Login with your account" class="btn-login">Login</a></div>');
}
return buf.join("");
};

this["Templates"]['profile'] = function anonymous(locals, attrs, escape, rethrow, merge) {
attrs = attrs || jade.attrs; escape = escape || jade.escape; rethrow = rethrow || jade.rethrow; merge = merge || jade.merge;
var buf = [];
with (locals || {}) {
var interp;
buf.push('<div class="box forgot-pwd"><h2>Account</h2><h3>' + escape((interp = email) == null ? '' : interp) + '</h3><p>Thanks for trying out the beta of Collector on the web.</p><p>We\'re working hard to bring here more features, such as support for Tumblr/Instagram collections and much more. Stay tuned!</p><a href="#" title="Logout" class="btn btn-logout">Logout</a></div>');
}
return buf.join("");
};

this["Templates"]['board-article'] = function anonymous(locals, attrs, escape, rethrow, merge) {
attrs = attrs || jade.attrs; escape = escape || jade.escape; rethrow = rethrow || jade.rethrow; merge = merge || jade.merge;
var buf = [];
with (locals || {}) {
var interp;
buf.push('<div class="w">');
if ( image)
{
if ( image.ratio)
{
buf.push('<a');
buf.push(attrs({ 'href':('#'), 'target':('_blank'), 'style':('padding-bottom:' + (image.ratio) + '%'), "class": ('img') }, {"href":true,"target":true,"class":true,"style":true}));
buf.push('><img');
buf.push(attrs({ 'src':('data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAEALAAAAAABAAEAAAIBTAA7'), 'data-original':('' + (image.url_archived_small) + ''), 'width':('100%'), "class": ('lazy') }, {"class":true,"src":true,"data-original":true,"width":true}));
buf.push('/></a>');
}
else
{
buf.push('<a href="#" target="_blank" style="padding-bottom:50%" class="img"><img');
buf.push(attrs({ 'src':('data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAEALAAAAAABAAEAAAIBTAA7'), 'data-original':('' + (image.url_original) + ''), 'width':('100%'), "class": ('lazy') }, {"class":true,"src":true,"data-original":true,"width":true}));
buf.push('/></a>');
}
}
buf.push('<div class="content"><h3>' + escape((interp = title) == null ? '' : interp) + '</h3>');
if ( description)
{
buf.push('<p>' + escape((interp = description) == null ? '' : interp) + '</p>');
}
if ( source.type == 'TwitterUser')
{
buf.push('<div class="posted-date">' + escape((interp = published_ago) == null ? '' : interp) + ' by ' + escape((interp = source.full_name) == null ? '' : interp) + '</div><img');
buf.push(attrs({ 'src':("" + (source.profile_image_url) + ""), "class": ('user-pic') }, {"src":true}));
buf.push('/>');
}
else
{
buf.push('<div class="posted-date">Posted ' + escape((interp = published_ago) == null ? '' : interp) + '</div><a');
buf.push(attrs({ 'href':(url), 'target':("_blank"), "class": ('source-url') }, {"href":true,"target":true}));
buf.push('>' + escape((interp = url_host) == null ? '' : interp) + '</a>');
}
buf.push('</div></div>');
}
return buf.join("");
...
this["Templates"]['board'] = function anonymous(locals, attrs, escape, rethrow, merge) {
attrs = attrs || jade.attrs; escape = escape || jade.escape; rethrow = rethrow || jade.rethrow; merge = merge || jade.merge;
var buf = [];
with (locals || {}) {
var interp;
buf.push('<div class="articles"></div>');
}
return buf.join("");
};

this["Templates"]['header'] = function anonymous(locals, attrs, escape, rethrow, merge) {
attrs = attrs || jade.attrs; escape = escape || jade.escape; rethrow = rethrow || jade.rethrow; merge = merge || jade.merge;
var buf = [];
with (locals || {}) {
var interp;
buf.push('<div class="top"><h1>Paperboard</h1>');
if ( user)
{
buf.push('<div class="search-bar"><a href="#" title="Search"></a></div><div class="settings">' + escape((interp = user.full_name) == null ? '' : interp) + '<img');
buf.push(attrs({ 'src':("" + (user.avatar.medium) + ""), "class": ('avatar') }, {"src":true}));
buf.push('/></div>');
}
buf.push('</div>');
if ( user)
{
buf.push('<div class="nav"><a href="#" title="Back to top" class="logo"></a><a href="#" class="toggle-sidebar">All boards</a><ul class="context"><li class="current"><a href="#">Everything</a></li><li><a href="#">Yesterday</a></li><li><a href="#">Pictures</a></li><li><a href="#">Videos</a></li></ul></div>');
}
}
return buf.join("");
};

this["Templates"]['login-overlay'] = function anonymous(locals, attrs, escape, rethrow, merge) {
attrs = attrs || jade.attrs; escape = escape || jade.escape; rethrow = rethrow || jade.rethrow; merge = merge || jade.merge;
var buf = [];
with (locals || {}) {
var interp;
buf.push('<p>Log in with your Twitter account to view your own timeline.</p><a href="#" class="button">View my tweets &rarr;</a><a href="#" class="nope">No, thanks — I just want to read the articles below</a>');
}
return buf.join("");
};

this["Templates"]['sidebar-item'] = function anonymous(locals, attrs, escape, rethrow, merge) {
attrs = attrs || jade.attrs; escape = escape || jade.escape; rethrow = rethrow || jade.rethrow; merge = merge || jade.merge;
var buf = [];
with (locals || {}) {
var interp;
buf.push('<a');
buf.push(attrs({ 'href':("board/" + (private_id) + ""), 'data-navigate':(true) }, {"href":true,"data-navigate":true}));
buf.push('>' + escape((interp = name) == null ? '' : interp) + '</a>');
}
return buf.join("");
};

this["Templates"]['sidebar'] = function anonymous(locals, attrs, escape, rethrow, merge) {
attrs = attrs || jade.attrs; escape = escape || jade.escape; rethrow = rethrow || jade.rethrow; merge = merge || jade.merge;
var buf = [];
with (locals || {}) {
var interp;
buf.push('<ul class="boards"><li><a href="/everything" data-navigate="data-navigate" class="icon-infinite">All boards</a></li></ul>');
}
return buf.join("");
};

this["Templates"]['suggestion'] = function anonymous(locals, attrs, escape, rethrow, merge) {
attrs = attrs || jade.attrs; escape = escape || jade.escape; rethrow = rethrow || jade.rethrow; merge = merge || jade.merge;
var buf = [];
with (locals || {}) {
var interp;
buf.push('<h3>' + escape((interp = source_name) == null ? '' : interp) + '</h3><div class="row"><span>' + escape((interp = domain) == null ? '' : interp) + '</span>');
if ( kind == 'twitter')
{
buf.push('<i>' + escape((interp = followers) == null ? '' : interp) + ' followers</i>');
}
else
{
buf.push('<i>' + escape((interp = relevance) == null ? '' : interp) + ' articles</i>');
}
buf.push('</div>');
}
return buf.join("");
...
(function() {
  (function(Backbone) {
    Backbone.OAuth = {
      url: function(endpoint, options) {
        ...
        token = Paperboard.getToken();
        if (!token) {
          return Paperboard.options.url + path;
        }
        token = "auth_token=" + (options.token ? options.token : token);
        if (path.indexOf('?') === -1) {
          token = '?' + token;
        } else {
          token = '&' + token;
        }
        return Paperboard.options.url + path + token;
      },
      ...
      getParam: function(name, url) {
        if (!url) {
          url = (location.search ? location.search : Backbone.history.search);
        }
      ...
      sync: function(method, model, options) {
        ...
        error = options.error;
        options.error = function(response, errorObj, description) {
          if (response.status === 401) {
            if (Paperboard.vent != null) {
              Paperboard.vent.trigger("auth:not_valid");
            }
          }
          if (typeof error === 'function') {
            return error(response, errorObj, description);
          }
        };
    ...
    return Backbone.AuthCollection = Backbone.Collection.extend({
      sync: Backbone.OAuth.sync
    });
  })(Backbone);
  ...
  this.Paperboard = (function(Backbone, Marionette) {
    var App;
    ...
    App.addInitializer(function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        module = _ref[_i];
        _results.push(this.module(module).Show());
      }
      return _results;
    });
    App.$window.resize(function() {
      ...
      if (!grid || this.__gridSize === grid) {
        return;
      }
      App.$html.removeClass("grid-" + this.__gridSize).addClass("grid-" + grid);
      App.vent.trigger("change:grid", grid);
      return this.__gridSize = grid;
    });
    App.$window.scroll(function() {
      var scrollTop;
      scrollTop = App.$window.scrollTop();
      if (scrollTop <= 60 && App.fixedHeader) {
        App.$html.removeClass('fixed-header');
        return App.fixedHeader = false;
      } else if (scrollTop > 60 && !App.fixedHeader) {
        App.$html.addClass('fixed-header');
        return App.fixedHeader = true;
      }
    });
    App.$html.on("click", "a[data-navigate]", function(event) {
      event.preventDefault();
      return App.navigate($(event.currentTarget).attr('href'), {
        trigger: true
      });
    });
    App.vent.on("auth:not_valid", function() {
    ...
    App.reqres.setHandler("set:user", function(user) {
    ...
    App.setToken = function(token) {
      ...
      return App.__token = token;
    };
    App.getToken = function() {
      return App.__token;
    };
    App.url = function(endpoint) {
      return App.options.url + endpoint;
    };
    App.on("before:start", function(options) {
      ...
      if (options.data) {
        ...
        return App.boards = new App.Entities.Boards(options.data.collections);
      } else {
        return App.boards = new App.Entities.Boards;
      }
    });
    App.on("start", function() {
      var route;
      App.$window.resize();
      route = this.options.route || App.rootRoute;
      if (!App.user) {
        route = 'login';
      }
      Backbone.history.start({
        pushState: true,
        silent: route !== this.options.route
      });
  ...
  this.Paperboard.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
    Entities.Article = Backbone.Model.extend({
      ...
      publishedAgo: function() {
        var published;
        published = moment(this.get("published_at") * 1000);
    ...
    return Entities.Articles = Backbone.AuthCollection.extend({
      _class: "Articles",
      model: Entities.Article,
      initialize: function(models, options) {
        return this.board = options.board;
      },
      url: function() {
        return "v3/collections/" + (this.board.get('private_id')) + "/links";
      },
      fetchMore: function(callback) {
        var url;
        url = this.url();
        if (this.length) {
          url += '?max_timestamp=' + encodeURIComponent(this.last().get('published_at'));
        }
        return this.fetch({
          url: url,
          update: true,
  ...
  this.Paperboard.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
    Entities.Board = Backbone.AuthModel.extend({
      ...
      url: function() {
        return "v3/collections/" + (this.get('private_id'));
      },
      initialize: function() {
        return this.articles = new Entities.Articles([], {
          board: this
        });
      }
    });
    ...
    return App.reqres.setHandler("find:board", function(private_id, callback) {
      var b, board, _i, _len, _ref;
      board = void 0;
      _ref = App.boards.models;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        b = _ref[_i];
        if (b.get('private_id') === private_id) {
          board = b;
          break;
        }
      }
  ...
  this.Paperboard.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
    return Entities.User = Backbone.AuthModel.extend({
      defaults: {
        full_name: "User"
      },
      token: function() {
  ...
  this.Paperboard.module("Auth", function(Auth, App, Backbone, Marionette, $, _) {
    Auth.Router = Marionette.AppRouter.extend({
      ...
      showLogin: function() {
        ...
        return App.content.show(new Auth.Login.View);
      }
    });
    return App.addInitializer(function() {
      return new Auth.Router;
    });
  });

  this.Paperboard.module("Auth.Login", function(Login, App, Backbone, Marionette, $, _) {
    return Login.View = Marionette.ItemView.extend({
      template: "login",
      className: "window",
      events: {
      ...
      showForgotPassword: function(event) {
        event.preventDefault();
        return App.navigate("forgot-password", {
          trigger: true
        });
      },
      keyUp: function(e) {
      ...
      doLogin: function(event) {
        ...
        this.email = this.ui.email.val();
        if (!this.email) {
          return this.ui.email.focus();
        }
        this.password = this.ui.password.val();
        if (!this.password) {
          return this.ui.password.focus();
        }
        this.ui.email.blur();
        ...
        Backbone.OAuth.post({
          ...
          success: function(data) {
            ...
            return App.navigate(App.rootRoute, true);
          },
          error: function() {
            return alert('The e-mail address or password you entered is not valid.');
          }
        });
        return false;
      },
  ...
  this.Paperboard.module("Boards.Board", function(Board, App, Backbone, Marionette, $, _) {
    Board.Article = Marionette.ItemView.extend({
      ...
      serializeData: function() {
        ...
        data = {
          ...
          published_ago: this.model.publishedAgo(),
        ...
        if (model.lead_image) {
          ...
          if (data.image && data.image.width && data.image.height) {
            ...
            if (data.image.ratio > 150) {
              data.image.ratio = 149;
            }
          }
        }
        return data;
    ...
    return Board.View = Marionette.CompositeView.extend({
      template: "board",
      tagName: "section",
      className: "board",
      ...
      initialize: function() {
        return _.bindAll(this, 'pageScroll');
      },
      fetch: function() {
        this.fetching = true;
      ...
      fetchMore: function() {
        ...
        return this.collection.fetchMore((function(_this) {
          return function() {
      ...
      pageScroll: function(event) {
        var $target;
        if (this.fetching || !this.firstLayout) {
          return;
        }
        $target = $(event.target);
      ...
      onBeforeDestroyCollection: function() {
        return this.ui.articles.masonry('destroy');
      },
      onBeforeDestroy: function() {
        return App.$window.off("scroll", this.pageScroll);
      },
      onRenderTemplate: function() {
        App.$window.on("scroll", this.pageScroll);
        return this.ui.articles.masonry({
      ...
      onRenderCollection: function() {
        ...
        window.setTimeout((function(_this) {
          return function() {
            return _this.ui.articles.masonry('layout');
          };
        })(this), 0);
        return window.setTimeout((function(_this) {
          return function() {
            if (_this.ui.articles.height() < App.$window.height()) {
              return _this.fetchMore();
            }
          };
        })(this), 500);
      },
      attachLazyLoad: function() {
        return this.$el.find('.lazy').removeClass('lazy').lazyload({
          effect: "fadeIn",
          container: this.ui.articles,
          threshold: 400
        });
      },
      attachHtml: function(collectionView, itemView, index) {
        if (itemView.model.get('description') !== '' && itemView.model.get('lead_image')) {
          this.ui.articles.append(itemView.el);
          this.ui.articles.masonry('addItems', itemView.el);
        }
        if (this.collection.length > 0 && index === (this.collection.length - 1)) {
          return this.onRenderCollection();
        }
      },
      onRender: function() {
  ...
  this.Paperboard.module("Boards", function(Boards, App, Backbone, Marionette, $, _) {
    Boards.Router = Marionette.AppRouter.extend({
      ...
      showBoard: function(id) {
        return App.request("find:board", id, function(board) {
          if (!board) {
            return App.navigate(App.rootRoute, true);
          }
          App.request("change:nav", board);
          board.articles.reset();
          return App.content.show(new Boards.Board.View({
            model: board,
  ...
  this.Paperboard.module("Header", function(Header, App, Backbone, Marionette, $, _) {
    Header.Show = function() {
      this.layout = new Header.View;
      return App.header.show(this.layout);
    };
    App.reqres.setHandler("change:nav", function(object) {
      if (!Header.layout) {
        Header.Show();
      }
      return Header.layout.setNav(object);
    });
    return App.vent.on("user:login", function() {
      if (Header.layout) {
        return Header.layout.render();
      } else {
        return Header.Show();
      }
    });
  ...
  this.Paperboard.module("Header", function(Header, App, Backbone, Marionette, $, _) {
    return Header.View = Marionette.ItemView.extend({
      template: "header",
      tagName: "header",
      events: {
      ...
      revealSidebar: function(event) {
        event.preventDefault();
        if (App.$html.hasClass('with-sidebar')) {
          return;
        }
        App.request("create:sidebar");
        return App.$html.addClass('with-sidebar');
      },
      setNav: function(object) {
        this.ui.nav.removeClass('type-twitter');
        if (object._class === 'Board') {
          this.ui.toggleSidebar.text(object.get('name'));
          if (object.get('name').indexOf('@') === 0) {
            return this.ui.nav.addClass('type-twitter');
          }
        }
      },
      ...
      onClose: function() {
        ...
        return App.sidebar.empty();
      }
    });
  });

  this.Paperboard.module("Sidebar", function(Sidebar, App, Backbone, Marionette, $, _) {
    Sidebar.Create = function() {
      return App.sidebar.show(new Sidebar.View({
        collection: App.boards
      }));
    };
    return App.reqres.setHandler("create:sidebar", function() {
  ...
  this.Paperboard.module("Sidebar", function(Sidebar, App, Backbone, Marionette, $, _) {
    Sidebar.Item = Marionette.ItemView.extend({
      ...
      didClickItem: function(event) {
        event.preventDefault();
        this.$el.closest('ul').find('a').removeClass('current');
        this.$el.find('a').addClass('current');
        return App.$html.removeClass('with-sidebar');
      },
      onRender: function() {
        if (this.model.get('name').indexOf('@') === 0) {
          return this.$el.find('a').addClass('icon-twitter');
        } else {
          return this.$el.find('a').addClass('icon-folder');
        }
      }
    });
    return Sidebar.View = Marionette.CompositeView.extend({
      template: "sidebar",
      tagName: "section",
      ...
      scheduleHideSidebar: function(event) {
        event.preventDefault();
        if (this.hideSidebarTimeout || !App.$html.hasClass('with-sidebar')) {
          return;
        }
        return this.hideSidebarTimeout = window.setTimeout((function(_this) {
          return function() {
            return App.$html.removeClass('with-sidebar');
          };
        })(this), 250);
      },
      clearSidebarTimeout: function() {
        if (this.hideSidebarTimeout) {
          clearTimeout(this.hideSidebarTimeout);
          return delete this.hideSidebarTimeout;
        }
      },
      onBeforeClose: function() {
        return this.clearSidebarTimeout();
      }
    });
  });
